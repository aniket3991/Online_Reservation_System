...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(match(loginId, password)){
            new ReservationForm().setVisible(true);
            this.dispose();
        }
        else{
            jLabel3.setText("Login Id or Password is not valid! Try Again");
        }
    ...
    public boolean match(String userId, String password) {
        ...
        final String path = "src/main/java/resources/reservation/User.txt";
        File file = new File(path);
        try {
            try (Scanner scan = new Scanner(file)) {
                while (scan.hasNextLine()) {
                    String[] word = scan.nextLine().split(" ");
                    if (word[0].equals(userId) && word[1].equals(password)) {
                        return true;
                    }
                }
            }
        } catch (FileNotFoundException ex) {
            System.out.println("User file not available in System!");
        }
        return false;
    }
}
